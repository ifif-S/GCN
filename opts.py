...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataset', type=str, default='citeseer', help='[cora | citeseer | pubmed]')
...
class TrainOptions(BaseOptions):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--nb_heads', type=int, default=3, help='number of head attentions')
